...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int nCmdShow) {
    WNDCLASSEXA wc = { sizeof(WNDCLASSEXA), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(nullptr), 
                       LoadIcon(nullptr, IDI_APPLICATION), LoadCursor(nullptr, IDC_ARROW), 
                       nullptr, nullptr, "WFSExplorer", nullptr };
    RegisterClassExA(&wc);
    
    HWND hwnd = CreateWindowExA(0, "WFSExplorer", "WFS Explorer - Wii U Partition Manager",
